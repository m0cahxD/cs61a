...
def shuffle(cards):
    ...
    >>> suits = ['Ã¢â„¢Â¡', 'Ã¢â„¢Â¢', 'Ã¢â„¢Â¤', 'Ã¢â„¢Â§']
    >>> cards = [card(n) + suit for n in range(1,14) for suit in suits]
    >>> cards[:12]
    ['AÃ¢â„¢Â¡', 'AÃ¢â„¢Â¢', 'AÃ¢â„¢Â¤', 'AÃ¢â„¢Â§', '2Ã¢â„¢Â¡', '2Ã¢â„¢Â¢', '2Ã¢â„¢Â¤', '2Ã¢â„¢Â§', '3Ã¢â„¢Â¡', '3Ã¢â„¢Â¢', '3Ã¢â„¢Â¤', '3Ã¢â„¢Â§']
    >>> cards[26:30]
    ['7Ã¢â„¢Â¤', '7Ã¢â„¢Â§', '8Ã¢â„¢Â¡', '8Ã¢â„¢Â¢']
    >>> shuffle(cards)[:12]
    ['AÃ¢â„¢Â¡', '7Ã¢â„¢Â¤', 'AÃ¢â„¢Â¢', '7Ã¢â„¢Â§', 'AÃ¢â„¢Â¤', '8Ã¢â„¢Â¡', 'AÃ¢â„¢Â§', '8Ã¢â„¢Â¢', '2Ã¢â„¢Â¡', '8Ã¢â„¢Â¤', '2Ã¢â„¢Â¢', '8Ã¢â„¢Â§']
    >>> shuffle(shuffle(cards))[:12]
    ['AÃ¢â„¢Â¡', '4Ã¢â„¢Â¢', '7Ã¢â„¢Â¤', '10Ã¢â„¢Â§', 'AÃ¢â„¢Â¢', '4Ã¢â„¢Â¤', '7Ã¢â„¢Â§', 'JÃ¢â„¢Â¡', 'AÃ¢â„¢Â¤', '4Ã¢â„¢Â§', '8Ã¢â„¢Â¡', 'JÃ¢â„¢Â¢']
    ...
    count = 0
    while count < split:
        temp.append(first[count])
        temp.append(second[count])
        count += 1
...
def reaches_circularity(G, v0):
    ...
    "*** YOUR CODE HERE ***"
    traversed = []
    def is_path_to_cycle(v1, traversed):
        for w in G[v1]:
            if w in traversed:
                return True
            traversed.append(w)
            if is_path_to_cycle(w, traversed):
                return True
            traversed.remove(w)
        return False
    return is_path_to_cycle(v0, traversed)
...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, input):
        ...
        nonlocal attempts
        if len(attempts) == 3:
            answer = "Your account is locked. Attempts: "
            answer = answer + str(attempts)
            return answer
        if input != password:
